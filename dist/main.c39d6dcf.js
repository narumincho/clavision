...
var $author$project$Main$RequestLineLogInUrl = {$: 'RequestLineLogInUrl'};
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$Events$onClick($author$project$Main$RequestLineLogInUrl)
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('LINE でログイン')
								]))
						]))
				]),
			function () {
				var _v1 = record.result;
				if (_v1.$ === 'Just') {
					if (_v1.a.$ === 'Ok') {
						var url = _v1.a.a;
						return _List_fromArray(
						...
						switch (_v1.a.a.$) {
							case 'BadUrl':
								...
								return _List_fromArray(
									[
										$elm$html$Html$text('urlが悪かった' + url)
									]);
							case 'Timeout':
								var _v2 = _v1.a.a;
								return _List_fromArray(
									[
										$elm$html$Html$text('タイムアウトした')
									]);
							case 'NetworkError':
								var _v3 = _v1.a.a;
								return _List_fromArray(
									[
										$elm$html$Html$text('ネットワークでエラーが発生しました')
									]);
							case 'BadStatus':
								var number = _v1.a.a.a;
								return _List_fromArray(
									[
										$elm$html$Html$text(
										'エラーが発生しました' + $elm$core$String$fromInt(number))
									]);
							default:
								var message = _v1.a.a.a;
								return _List_fromArray(
									[
										$elm$html$Html$text('レスポンスのデコードでエラーが発生しました ' + message)
									]);
						}
					}
				} else {
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Url.Url":{"args":[],"type":"{ protocol : Url.Protocol, host : String.String, port_ : Maybe.Maybe Basics.Int, path : String.String, query : Maybe.Maybe String.String, fragment : Maybe.Maybe String.String }"}},"unions":{"Main.Msg":{"args":[],"tags":{"RequestLineLogInUrl":[],"ResponseLineLogInUrl":["Result.Result Http.Error Url.Url"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String.String"],"Timeout":[],"NetworkError":[],"BadStatus":["Basics.Int"],"BadBody":["String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Url.Protocol":{"args":[],"tags":{"Http":[],"Https":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
